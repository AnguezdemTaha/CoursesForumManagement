 ...
 * @author lm
 */
@WebServlet(name = "Ajouter_filiere", urlPatterns = {"/Ajouter_filiere"})
public class Ajouter_filiere extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Ajouter_filiere</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Ajouter_filiere at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if(Module_filiere_anneeDao.AjouterFiliere(filiere)){
           String message="Un neuveux filiere été ajouter avec succée";
