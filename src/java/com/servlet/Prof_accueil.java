 ...
 * @author lm
 */
@WebServlet(name = "Prof_accueil", urlPatterns = {"/Prof_accueil"})
public class Prof_accueil extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Prof_accueil</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Prof_accueil at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      /* String nom =request.getParameter("nom");
       ...
       String type=request.getParameter("type");
        ...
        Utilisateur utilisateur1=utilisateurdao.chercher(utilisateur);
       
        Module_filiere_anneeDao module_filiere = new Module_filiere_anneeDao();
        
        request.setAttribute("modules", module_filiere.recupererModulesprof(utilisateur1));
