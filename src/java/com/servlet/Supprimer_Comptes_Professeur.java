 ...
 * @author lm
 */
@WebServlet(name = "Supprimer_Comptes_Professeur", urlPatterns = {"/Supprimer_Comptes_Professeur"})
public class Supprimer_Comptes_Professeur extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Supprimer_Comptes_Professeur</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Supprimer_Comptes_Professeur at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(utilisateur.Supprimerprofs(id_professeurs)){
           String message="Vous aves supprimer des profs avec succée";
           //request.setAttribute("module",list );
           request.setAttribute("message1",message );
              request.setAttribute("professeurs", utilisateur.recupererProfesseurs());
        this.getServletContext().getRequestDispatcher("/adm_supprimer_compte_professeur.jsp").forward(request, response);
