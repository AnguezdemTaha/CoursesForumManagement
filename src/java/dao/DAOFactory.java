...
public class DAOFactory {
    ...
    /* Méthode chargée de fournir une connexion à la base de données */
     /* package */ Connection getConnection() throws SQLException{
         //System.out.print("url,username,pass ="+url +"..."+username+"..."+password);
        
         //cnx dont wann establish i think whouse the initialisation of factory didit wrk so we try this now :
         //Class.forName( driver );
     ...
     * pour le moment)
     */
    public UserDaoImpl getUtilisateurDao() {
