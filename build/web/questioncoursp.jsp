<%-- 
    Document   : questioncoursp
    Created on : 3 janv. 2020, 21:14:39
    Author     : lm
--%>
                                            ...
                                            <div class="accordions" id="accordion" role="tablist" aria-multiselectable="true">
                                               ...
                                               <c:forEach var="map" items="${ maps4 }">
                                                ...
                                                <div class="panel single-accordion">
                                                    ...
                                                    <h6>
                                                        <a role="button" class="collapsed" aria-expanded="true" aria-controls="<c:out value="${map.key.contenu}"/>" data-parent="#accordion" data-toggle="collapse" href="#<c:out value="${map.key.contenu}"/>"><c:out value="${map.key.contenu}"/>
                                                        <span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                                        <span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                                        </a>
                                                    </h6>
                                                    <div id="<c:out value="${map.key.contenu}"/>" class="accordion-content collapse">
                                                        ...
                                                        <form method="post" action="Ajouter_reponse">
                                                            ...
                                                            <textarea id="story" name="reponse" rows="5" class="form-control"></textarea><br>
                                                            </div>
