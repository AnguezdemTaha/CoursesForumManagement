<%-- 
    Document   : demande_adm
    Created on : 15 nov. 2019, 11:08:00
    Author     : lm
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="forms">
                            ...
                            <form  class="" id="myForm" method="POST" action="Demande_admin">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button class="btn clever-btn w-100">Ajouter l'étudiant</button>
                                    </div>
